...
// Composant graphique shadcn (wrapper autour de Recharts) : ChartContainer +
// tooltip/legend thématisés via des variables CSS injectées par ChartStyle.
...
// Extrait la config d'un item de payload Recharts.
